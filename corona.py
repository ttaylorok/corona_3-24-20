...
df = pd.read_excel("COVID-19-geographic-disbtribution-worldwide-2020-03-24.xlsx")

df.rename({"Bahamas" : "Bahamas",
           "Belarus": "Byelarus",
...
#df = file.set_index(keys=["Countries and territories","Year","Month","Day"])
...
w = shapefile.Writer('countries_data_corona')
